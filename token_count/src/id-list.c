...
static struct ID *idroot;

void init_idtab(void) {		/* Initialise the table */
	idroot = NULL;
}
...
void print_idtab(void) {	/* Output the registered data */
	struct ID *p;
...
void release_idtab(void) {	/* Release tha data structure */
	struct ID *p, *q;
